        ...
        <div class="row">
                ...
                <ul class="list-group list-group-flush">
                    @foreach ($categorias as $c)
                        <li
                            ...
                            <a href="{{ route('categorias.index', ['categoria' => $c->id_categoria_negocio]) }}"
            ...
            <div class="col-md-9">
                @if ($categoriaSeleccionada)
                    <h2 class="fw-bold mb-4">Categoría: {{ $categoriaSeleccionada->nombre_categoria }}</h2>
                    <div class="row gy-4">
                        ...
                        @empty
                            <div class="col-12">
                                <p class="text-muted text-center">No hay comercios en esta categoría.</p>
                            </div>
                        @endforelse
                    </div>
                @else
                    <h2 class="fw-bold mb-4">Selecciona una categoría</h2>
                    <p class="text-muted">Elige una categoría en la lista de la izquierda para ver los comercios
                        disponibles.</p>
                @endif
            </div>
        </div>
